...
*********************************************
.. _pydro_sw_flow:
.. figure:: _imgs/pydroponia_sw_flow.jpg
   :align: center

   Diagrama de bloques componentes del software |pydroponia|
...
.. code-block:: console
   ...
   cd ${HOME}
   git clone https://jlulloa@bitbucket.org/jlulloa/pydroponia.git
   cd pydroponia
   ./setup.sh
   sudo reboot
